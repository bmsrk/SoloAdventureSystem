...
public class GenerationException : Exception
{
    ...
    public GenerationException(string message) : this("Unknown", message) { }

    public GenerationException(string message, Exception innerException) : this("Unknown", message, innerException) { }
}
